                            ...
                            <div className="collections_container">
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/paper.png' alt=''  width={27} height={27}/>
                                    </span>
                                    <h3 className="">
                                        Payroll
                                    </h3>
                                ...
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/3d.svg' alt='' width={27} height={27}/>
                                    </span>
                                    <h3>
                                ...
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/note.svg' alt='' width={27} height={27}/>
                                    </span>
                                    <h3 className="">
                                        Disbursement
                                    </h3>
                                ...
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/file.svg' alt='' width={27} height={27}/>
                                    </span>
                                    <h3 className="">
                                        E-receipts 
                                    </h3>
                                ...
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/star.svg' alt='' width={27} height={27}/>
                                    </span>
                                    <h3>
                                        Ease of Use
                                    </h3>
                                ...
                                <div className="collections_item">
                                    <span className="collection_img">
                                        <Image src='/img/checkl.svg' alt='' width={27} height={27}/>
                                    </span>
                                    <h3>
                                        Guarantee of funds 
                                    </h3>
