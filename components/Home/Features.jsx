        ...
        >
            ...
            <Container>
                <SectionFeatures>
                    <Column divide={4}>
                        <FeatureBox>
                            <Image src='/img/lable.svg' alt='' width={60} height={60}/>
                            <p>Enjoy free payments  for individuals & businesses </p>
                        </FeatureBox>
                    </Column>
                    <Column divide={4}>
                        <FeatureBox>
                            <Image src='/img/lock.svg' alt='' width={60} height={60}/>
                            <p>Privacy and Security  are guaranteed  </p>
                        </FeatureBox>
                    </Column>
                    <Column divide={4}>
                        <FeatureBox>
                            <Image src='/img/layers.svg' alt='' width={60} height={60}/>
                            <p>We accept multiple modes of payments</p>
                        </FeatureBox>
                    </Column>
                    <Column divide={4}>
                        <FeatureBox>
                            <Image src='/img/chart.svg' alt='' width={60} height={60}/>
                    ...
                    <Featurecolumn>
                        ...
                        <div className="featurescontainer">
                            <div className="features">
                                <Image src='/img/scan.png' alt='' width={20} height={25}/>
                                <h3>QR code</h3>
                            </div>
                            <div className="features">
                                <Image src='/img/cpu.svg' alt='' width={20} height={25}/>
                                <h3>avs</h3>
                            </div>
                            <div className="features">
                                <Image src='/img/switch.png' alt=''width={20} height={25}/>
                                <h3>Bank Transfer</h3>
                            </div>
                            <div className="features">
                                <Image src='/img/desktop.svg' alt='' width={20} height={25}/>
                                <h3>Web</h3>
                            </div>
                            <div className="features">
                                <Image src='/img/tablet.png' alt='' width={20} height={25}/>
                                <h3>Mobile</h3>
                            </div>
                            <div className="features">
                                <Image src='/img/tablet.png' alt='' width={20} height={25}/>
